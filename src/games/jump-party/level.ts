...
export const jumpPartyLevel = {
  ...
  objects: [
    ...
    { id: 'b4', type: 'balloon', colour: 'purple', x: 535, y: 215, bobHeight: 14, bobDuration: 1950 },
    ...
    { id: 'b8', type: 'balloon', colour: 'purple', x: 975, y: 225, bobHeight: 14, bobDuration: 1550 },
    { id: 'b9', type: 'balloon', colour: 'pink', x: 1085, y: 410, bobHeight: 21, bobDuration: 1900 },
    { id: 'b10', type: 'balloon', colour: 'yellow', x: 1135, y: 205, bobHeight: 12, bobDuration: 1600 },
